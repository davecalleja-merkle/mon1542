...
This project includes **1 pre-configured components**:

- **all-shadcn** - Ready to use with proper styling and TypeScript types

Components are automatically installed and configured when you run `pnpm run setup`.
